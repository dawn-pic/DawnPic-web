          ...
          <nav className="flex gap-3 mx-auto text-orange-600 font-extrabold text-2xl h-(--header-height)" style={{ maxWidth: "min(1024px, calc(100vw - 1.5rem))" }}>
            {userStatus.loggedIn ? (
              <>
                ...
                <button className="flex mb-auto p-1 transition-all bg-orange-300 rounded-b hover:pt-2 shadow-sm hover:shadow-lg"><Link href="/images">My images</Link></button>
              </>
            ) : (
              <>
                <button className="flex ml-auto mb-auto p-1 transition-all bg-orange-300 rounded-b hover:pt-2 shadow-sm hover:shadow-lg"><Link href="/signup">Sign Up</Link></button>
                <button className="flex mr-2 mb-auto p-1 transition-all bg-orange-300 rounded-b hover:pt-2 shadow-sm hover:shadow-lg"><Link href="/signin">Sign In</Link></button>
              </>
            )}
          </nav>
